...
Thanks for considering a contribution to pyrig-fixtures! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-fixtures/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-fixtures/actions/workflows/health_check.yml) must pass before merge.
